...
#define SHRLOG_FIXED_APPS_ADDRESS   (0xFFFFFF8000100000UL + 0x1FEFE0)
...
typedef struct
{
	...
	unsigned long log_oops_buf_addr;
	unsigned long log_oops_first_seq_addr;
	unsigned long log_oops_last_seq_addr;
	...
	unsigned long cpu_context_fp_offset;
	unsigned long cpu_context_sp_offset;
	unsigned long cpu_context_pc_offset;
