...
//			prox_subscribe();
			...
			if (p_sh_smem_common_type != NULL) {
				...
				prox_params.threshold_low = p_sh_smem_common_type->shdiag_proxadj[0];
				prox_params.threshold_high = p_sh_smem_common_type->shdiag_proxadj[1];
