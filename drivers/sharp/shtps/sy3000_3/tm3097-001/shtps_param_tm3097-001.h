 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_PERF_LOCK_CLOCK_FREQUENCY, 			864000);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_HULL_LEAVE_MAX_DOT,			30);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_HULL_COUNT,					14);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_HULL_HIGH_SPEED_RATIO,		4);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_HULL_LOW_SPEED_RATIO,		4);
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_SLOW_JUDGE_COUNT,			14);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_LEAVE_MAX_DOT,						25);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_WEIGHTED_MOVING_AVE_DENOMINATOR,	9);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_RATIO,								9);
