 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE,			202);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO,			90);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO_2,		86);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME,		707);
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_TOP_AREA_RELATION_ZWY_RATIO,	58);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_TOP_AREA_RELATION_ZWY_DIFF,	1700);
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_BOTTOM_AREA_RELATION_ZWY_RATIO,	58);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_BOTTOM_AREA_RELATION_ZWY_DIFF,	1700);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DYNAMIC_RESET_WHEN_WAKEUP_REZERO_ENABLE,	0);
