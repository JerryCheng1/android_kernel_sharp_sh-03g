...
typedef int (*fwctl_if_initparam_transition_tuning_t)(struct shtps_fwctl_info *);
...
struct shtps_fwctl_functbl{
	...
	fwctl_if_initparam_transition_tuning_t				initparam_transition_tuning_f;
...
/* --------------------------------------------------------------------------- */
	...
	#define shtps_fwctl_initparam_transition_tuning(ts)									ts->fwctl_p->fwctl_func_p->initparam_transition_tuning_f(ts->fwctl_p)
	...
	int shtps_fwctl_initparam_transition_tuning(struct shtps_rmi_spi *);
