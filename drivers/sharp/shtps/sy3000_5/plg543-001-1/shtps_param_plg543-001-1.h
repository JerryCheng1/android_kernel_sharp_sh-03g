 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_EXCLUDE_DOT,					1000);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_LEAVE_MAX_DOT,						20);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_WEIGHTED_MOVING_AVE_DENOMINATOR,	9);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_WEIGHTED_MOVING_AVE_DENOMINATOR_HIGH_REPORT_RATE,	8);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_RATIO,								9);
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_RATIO_HIGH_REPORT_RATE,				8);
