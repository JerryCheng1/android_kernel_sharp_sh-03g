...
/* -------------------------------------------------------------------------- */
	...
	void shtps_record_log_file_deinit(struct shtps_rmi_spi *ts);
        ...
        enum {
            SHTPS_DURABLE_RESULT_SUCCESS,
            SHTPS_DURABLE_RESULT_FAILURE
        };

        enum {
            SHTPS_DURABLE_LOG_TYPE_LCD_ON,
            SHTPS_DURABLE_LOG_TYPE_LCD_OFF,
            SHTPS_DURABLE_LOG_TYPE_REZERO
        };
#else
