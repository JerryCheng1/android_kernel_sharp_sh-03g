#ifdef DEL_COMMENT
/* drivers/sharp/shdisp_lcdc/shdisp_dbg.c  (Display Driver)
 *
...
#define SHDISP_DBG_SUBCODE_I2CERR_BDIC_STR          "I2C_ERR_BDIC,      "
#define SHDISP_DBG_SUBCODE_I2CERR_CLMR_STR          "I2C_ERR_CMLR,      "
...
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE17         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     ...
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE18         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_ESDMIPI_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE19         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_DEVCODE_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE20         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_DISPNG_STR     \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE21         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_DETLOW_STR     \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE22         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_ESDDETIN_STR   \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE23         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_ESDMIPI_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE24         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_BDIC_STR          \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_I2CREAD_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE25         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_I2CERR_BDIC_STR \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE26         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_I2CERR_CLMR_STR \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE27         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_PSREQ_STR      \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE28         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_RECOVNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE29         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_PSALSNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE30         (SHDISP_DBG_MODE_LINUX_STR         \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_POWERNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE31         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_TIMEOUT_STR       \
                                                     SHDISP_DBG_SUBCODE_COMMAND_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE32         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_TIMEOUT_STR       \
                                                     SHDISP_DBG_SUBCODE_BOOT_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE33         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_TIMEOUT_STR       \
                                                     SHDISP_DBG_SUBCODE_MIF_STR        \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE34         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_HSERROR_STR       \
                                                     SHDISP_DBG_SUBCODE_NOTCOMP_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE35         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_HSERROR_STR       \
                                                     SHDISP_DBG_SUBCODE_MISMATCH_STR   \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE36         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_CMDERR_STR        \
                                                     SHDISP_DBG_SUBCODE_NONE_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE37         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_ASYNCERR_STR      \
                                                     SHDISP_DBG_SUBCODE_NONE_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE38         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_CLMR_HW_STR       \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_DEVCODE_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE39         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_CLMR_HW_STR       \
                                                     SHDISP_DBG_CODE_UNKHINT_STR       \
                                                     SHDISP_DBG_SUBCODE_NONE_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE40         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_DEVCODE_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE41         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_STATUS_STR     \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE42         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_DISPNG_STR     \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE43         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_BDIC_STR          \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_I2CREAD_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE44         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_PSALSNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE45         (SHDISP_DBG_MODE_APPSBL_STR        \
                                                     SHDISP_DBG_TYPE_PSALS_STR         \
                                                     SHDISP_DBG_CODE_RETRYOVER_STR     \
                                                     SHDISP_DBG_SUBCODE_POWERNG_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE46         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_TIMEOUT_STR       \
                                                     SHDISP_DBG_SUBCODE_COMMAND_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE47         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_TIMEOUT_STR       \
                                                     SHDISP_DBG_SUBCODE_BOOT_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE48         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_HSERROR_STR       \
                                                     SHDISP_DBG_SUBCODE_NOTCOMP_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE49         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_HSERROR_STR       \
                                                     SHDISP_DBG_SUBCODE_MISMATCH_STR   \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE50         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_CMDERR_STR        \
                                                     SHDISP_DBG_SUBCODE_NONE_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE51         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_CLMR_FW_STR       \
                                                     SHDISP_DBG_CODE_ASYNCERR_STR      \
                                                     SHDISP_DBG_SUBCODE_NONE_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE52         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_CLMR_HW_STR       \
                                                     SHDISP_DBG_CODE_UNKHINT_STR       \
                                                     SHDISP_DBG_SUBCODE_NONE_STR       \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE53         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_DEVCODE_STR    \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE54         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_READERR_STR       \
                                                     SHDISP_DBG_SUBCODE_STATUS_STR     \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE55         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_DISPNG_STR     \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE56         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_DETLOW_STR     \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE57         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_ESDDETIN_STR   \
                                                     "   0  \n")
#define SHDISP_DBG_ERROR_LOG_SUMMARY_LINE58         (SHDISP_DBG_MODE_LINUX_BOOTING_STR \
                                                     SHDISP_DBG_TYPE_PANEL_STR         \
                                                     SHDISP_DBG_CODE_ERRDET_STR        \
                                                     SHDISP_DBG_SUBCODE_ESDMIPI_STR    \
                                                     "   0  \n")
...
const static struct shdisp_dbg_error_code ErrorCodeIndex[] = {
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_COMMAND          },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_BOOT             },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_MIF              },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_HANDSHAKE_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NOT_COMPLETE     },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_HANDSHAKE_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NUMBER_MISMATCH  },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_COMMAND_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_UNEXPECT_HINT,
                                                                                SHDISP_DBG_SUBCODE_COMMAND          },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_UNEXPECT_HINT,
                                                                                SHDISP_DBG_SUBCODE_BOOT             },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_UNEXPECT_HINT,
                                                                                SHDISP_DBG_SUBCODE_MIF              },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_ASYNC_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_HW,    SHDISP_DBG_CODE_RETRY_OVER,
                                                                                SHDISP_DBG_SUBCODE_DEVCODE          },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_CLMR_HW,    SHDISP_DBG_CODE_UNKNOWN_HINT,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    ...
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_PSALS,      SHDISP_DBG_CODE_ERROR_DETECT,
                                                                                SHDISP_DBG_SUBCODE_I2C_ERROR_BDIC   },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_PSALS,      SHDISP_DBG_CODE_ERROR_DETECT,
                                                                                SHDISP_DBG_SUBCODE_I2C_ERROR_CLMR   },
    {SHDISP_DBG_MODE_LINUX_BOOTED,  SHDISP_DBG_TYPE_PSALS,      SHDISP_DBG_CODE_ERROR_DETECT,
    ...
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_COMMAND          },
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_BOOT             },
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_MIF              },
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_HANDSHAKE_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NOT_COMPLETE     },
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_HANDSHAKE_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NUMBER_MISMATCH  },
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_COMMAND_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_ASYNC_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_CLMR_HW,    SHDISP_DBG_CODE_RETRY_OVER,
                                                                                SHDISP_DBG_SUBCODE_DEVCODE          },
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_CLMR_HW,    SHDISP_DBG_CODE_UNKNOWN_HINT,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    ...
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_PANEL,      SHDISP_DBG_CODE_ERROR_DETECT,
                                                                                SHDISP_DBG_SUBCODE_DISPON_NG        },
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_BDIC,       SHDISP_DBG_CODE_RETRY_OVER,
                                                                                SHDISP_DBG_SUBCODE_I2C_READ         },
    ...
    {SHDISP_DBG_MODE_APPSBL,        SHDISP_DBG_TYPE_PSALS,      SHDISP_DBG_CODE_RETRY_OVER,
                                                                                SHDISP_DBG_SUBCODE_POWER_ON_NG      },
    {SHDISP_DBG_MODE_LINUX_BOOTING, SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_COMMAND          },
    {SHDISP_DBG_MODE_LINUX_BOOTING, SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_TIMEOUT,
                                                                                SHDISP_DBG_SUBCODE_BOOT             },
    {SHDISP_DBG_MODE_LINUX_BOOTING, SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_HANDSHAKE_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NOT_COMPLETE     },
    {SHDISP_DBG_MODE_LINUX_BOOTING, SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_HANDSHAKE_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NUMBER_MISMATCH  },
    {SHDISP_DBG_MODE_LINUX_BOOTING, SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_COMMAND_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    {SHDISP_DBG_MODE_LINUX_BOOTING, SHDISP_DBG_TYPE_CLMR_FW,    SHDISP_DBG_CODE_ASYNC_ERROR,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
    {SHDISP_DBG_MODE_LINUX_BOOTING, SHDISP_DBG_TYPE_CLMR_HW,    SHDISP_DBG_CODE_UNKNOWN_HINT,
                                                                                SHDISP_DBG_SUBCODE_NONE             },
...
const static const char *SummaryFormat[] = {
    ...
    SHDISP_DBG_ERROR_LOG_SUMMARY_LINE58,
};
...
static int shdisp_vprintk(const char *fmt, va_list args, int offset)
{
    ...
    memset(printk_buf, 0x20, sizeof(printk_buf));
...
/* ------------------------------------------------------------------------- */
int shdisp_dbg_ringbuffer_dump(char *buf)
{
    int l;
    int s;
    int len = 0;
...
/* ------------------------------------------------------------------------- */
void shdisp_dbg_API_ringbuffer_dump(void)
{
    int l;
    int s;
    int len = 0;
    ...
    while (len < LOG_BUF_SIZE) {
        ...
        if (s >= LOG_BUF_SIZE) {
            ...
            while (s < LOG_BUF_SIZE && l < LINE_BUF_SIZE - 2) {
...
static size_t shdisp_dbg_get_stacktrace(char *stackdumpbuf, size_t length)
{
   ...
   SHDISP_INFO("shdisp_dbg_get_stacktrace ptr=0x%p len=%ld", stackdumpbuf, length);
    while (1) {
        int urc, rtn;
    ...
    SHDISP_INFO("dump stuck trace size=%ld", writelen);
    return writelen;
}

#if defined(CONFIG_ANDROID_ENGINEERING)
/* ------------------------------------------------------------------------- */
/* shdisp_dbg_set_fail_retry_flg                                             */
/* ------------------------------------------------------------------------- */
...
{
    SHDISP_INFO("reset = %d", fw_err_sysetem_reset);
...
static int shdisp_dbg_summary_init_file(void)
{
    ...
    SHDISP_INFO("open file: %s pid=%d tgid=%d comm=%s", SHDISP_DBG_DISPLAY_ERROR_FILE, current->pid, current->tgid,
                                                                                                       current->comm);
...
static void shdisp_dbg_summary_countup_line(char *buf)
{
    ...
    if (*pCount1000 == '9' && *pCount100 == '9' && *pCount10 == '9' && *pCount1 == '9') {
        SHDISP_INFO("Counter is Max Value %c%c%c%c", *pCount1000, *pCount100, *pCount10, *pCount1);
        return;
    }
...
static void shdisp_dbg_reset_work_add_command(struct shdisp_dbg_reset_work_command *cmd)
{
    SHDISP_INFO("add queue: proc=%pS arg=%p", cmd->proc, cmd->arg);
...
static void shdisp_dbg_reset_work_worker(struct work_struct *wk)
{
    ...
    for (; ;) {
        ...
        SHDISP_INFO("execute: proc=%pS arg=%p", cmd->proc, cmd->arg);
...
static void shdisp_dbg_reset_work_start(void)
{
    ...
    if (shdisp_dbg_reset_work_wq != NULL) {
        if (queue_work(shdisp_dbg_reset_work_wq, &shdisp_dbg_reset_work_wk) == 0) {
            SHDISP_INFO("work already pending.");
        }
    } else {
...
static ssize_t shdisp_dbg_zip_write(struct shdisp_dbg_zip_context *ctx, const char *buf, size_t len)
{
    if (ctx->ready) {
        ...
        if (l < len) {
            SHDISP_ERR("not enough input buffer. remain=%d data=%ld", remain, len);
        }
...
static int shdisp_dbg_dispdump_check_max_file_number(void)
{
    ...
    trap = kern_path_locked(buf, &parent);
    __putname(buf);

    if (IS_ERR_OR_NULL(trap)) {
        error = PTR_ERR(trap);
        if (error) {
            SHDISP_ERR("file error. error=%d", error);
        }
    } else {
        if (trap->d_inode) {
            SHDISP_INFO("dumpfile is full.");
            error = -EEXIST;
        }
        dput(trap);
...
static int shdisp_dbg_dispdump_file_rotation(void)
{
    ...
    if (IS_ERR_OR_NULL(trap)) {
        error = PTR_ERR(trap);
        if (error) {
            SHDISP_ERR("file error. file='%s' error=%d", buf, error);
        }
    } else {
        if (trap->d_inode) {
            SHDISP_INFO("unlink file. file='%s'", buf);
            error = vfs_unlink(parent.dentry->d_inode, trap);
        }
        dput(trap);
        mutex_unlock(&parent.dentry->d_inode->i_mutex);
        path_put(&parent);
    ...
    for (seqno = SHDISP_FWTO_DUMPFILE_NUM - 1; seqno > 0; seqno--) {
        ...
        d_from = kern_path_locked(buf, &parent);
        if (IS_ERR_OR_NULL(d_from)) {
            error = PTR_ERR(d_from);
            if (error) {
                SHDISP_ERR("file error. seqno=%d file='%s' error=%d", seqno, buf, error);
            }
            continue;
        }
        if (!d_from->d_inode) {
            SHDISP_INFO("file not exist. seqno=%d file='%s'", seqno, buf);
            dput(d_from);
            mutex_unlock(&parent.dentry->d_inode->i_mutex);
            path_put(&parent);
            continue;
        ...
        d_to = lookup_one_len(buf, parent.dentry, strlen(buf));
        ...
        if (d_to->d_inode) {
            SHDISP_INFO("file already exist. seqno=%d file='%s'", seqno, buf);
            dput(d_from);
            dput(d_to);
            mutex_unlock(&parent.dentry->d_inode->i_mutex);
            path_put(&parent);
        ...
        SHDISP_INFO("rename file. seqno=%d", seqno);
        error = vfs_rename(parent.dentry->d_inode, d_from, parent.dentry->d_inode, d_to);
        ...
        if (error) {
            SHDISP_ERR("Dumpfile rename error seqno=%d errno=%d", seqno, error);
            break;
        }
    }
