/* drivers/sharp/shdisp_lcdc/shdisp_clmr_usr.c  (Display Driver)
 *
...
int shdisp_ioctl_lcdc_i2c_write(void __user *argp)
{
    ...
    if (ret == 0) {
        ...
        shdisp_FWCMD_buf_add_multi(SHDISP_CLMR_FWCMD_I2C_MULTI_WRITE, (lcdc_i2c.slave_addr << 1), 0x00, lcdc_i2c.size,
                                                                                                        lcdc_i2c.buf);
...
/*---------------------------------------------------------------------------*/
/*  shdisp_ioctl_lcdc_set_ewb_tbl2                                           */
/*---------------------------------------------------------------------------*/
...
int shdisp_ioctl_lcdc_fw_cmd_write(void __user *argp)
{
    ...
    SHDISP_DEBUG("[SHDISP] fw_cmd.write_val[0-3]=%02x%02x%02x%02x\n", fw_cmd.write_val[0], fw_cmd.write_val[1],
                                                                      fw_cmd.write_val[2], fw_cmd.write_val[3]);
...
int shdisp_ioctl_lcdc_fw_cmd_read(void __user *argp)
{
    ...
    SHDISP_DEBUG("[SHDISP] fw_cmd.read_val[0-3]=%02x%02x%02x%02x\n", fw_cmd.read_val[0], fw_cmd.read_val[1],
                                                                     fw_cmd.read_val[2], fw_cmd.read_val[3]);
    SHDISP_DEBUG("[SHDISP] fw_cmd.read_val[4-7]=%02x%02x%02x%02x\n", fw_cmd.read_val[4], fw_cmd.read_val[5],
                                                                     fw_cmd.read_val[6], fw_cmd.read_val[7]);
