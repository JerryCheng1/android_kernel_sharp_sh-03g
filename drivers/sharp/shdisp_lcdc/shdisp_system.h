/* drivers/sharp/shdisp_lcdc/shdisp_system.h  (Display Driver)
 *
...
#define SHDISP_BLSP_ID_BL_I2C BLSP_ID_6
#define SHDISP_GPIO_NUM_BL_I2C_SDA        (29)
#define SHDISP_GPIO_NUM_BL_I2C_SCL        (30)
...
#define SHDISP_HW_REV_BIT_ES05      (2)
...
#define SHDISP_CLMR_FWCMD_DSI_LP_MULTI_SWRITE_A       (0xAA)
#define SHDISP_CLMR_FWCMD_DSI_LP_MULTI_SWRITE_B       (0xBA)
#define SHDISP_CLMR_FWCMD_DSI_LP_MULTI_SWRITE_C       (0xCA)
...
#define SHDISP_CLMR_FWCMD_I2C_BANK_SET                (0x5F)
...
#define SHDISP_CLMR_FWCMD_LIGHTCTL_READ_NOFILTER      (0x6A)
...
#define SHDISP_CLMR_FWCMD_SLEEP_LESS_MODE             (0xF3)
#define SHDISP_CLMR_FWCMD_RATE_CHECK_MODE             (0xF4)
#define SHDISP_CLMR_FWCMD_LCD_ASSIST_MODE             (0xF5)
