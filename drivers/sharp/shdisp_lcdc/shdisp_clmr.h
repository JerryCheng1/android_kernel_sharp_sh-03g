/* drivers/sharp/shdisp_lcdc/shdisp_clmr.h  (Display Driver)
 *
...
#define SHDISP_CLMR_EDRAM_CA    3
    ...
    #define CALI_PLL1CTL2_VAL       0x3E0143C
    ...
    #define CALI_PLL1CTL2_VAL_C     0x10901442
    #define CALI_PLL1CTL3_VAL_C     CALI_PLL1CTL3_VAL
#else  /* defined(CONFIG_SHDISP_PANEL_GEMINI) */
    #define CALI_PLL1CTL_VAL        (0x0000B220)
    #define CALI_PLL1CTL2_VAL       (0x2F701447)
    #define CALI_PLL1CTL3_VAL       (0x00042001)
    #define CALI_PLL1CTL_VAL_B      (0x0000B220)
    #define CALI_PLL1CTL2_VAL_B     (0x2FE01444)
...
#if defined(CONFIG_SHDISP_PANEL_ANDY)
    #define CALI_PTGHP_VAL          8
    #define CALI_PTGHB_VAL          16
    #define CALI_PTGHF_VAL          72
...
enum {
    SHDISP_RESULT_FW_SUCCESS = 0,
    SHDISP_RESULT_FW_ERR,
    SHDISP_RESULT_FW_ERR_DUMP,
};
