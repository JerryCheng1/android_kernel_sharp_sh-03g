/* drivers/sharp/shdisp_lcdc/shdisp_panel.h  (Display Driver)
 *
...
#define SHDISP_PANEL_VDDON_CHK_OFF       0
#define SHDISP_PANEL_VDDON_CHK_ON        1
...
enum {
    SHDISP_PANEL_RATE_CTRL_NOT_SET,
    SHDISP_PANEL_RATE_CTRL_SET,
};
...
struct shdisp_panel_operations {
    ...
    int (*set_flicker) (struct shdisp_diag_flicker_param flicker_param);
    int (*get_flicker) (struct shdisp_diag_flicker_param *flicker_param);
    int (*get_flicker_low) (struct shdisp_diag_flicker_param *flicker_param);
