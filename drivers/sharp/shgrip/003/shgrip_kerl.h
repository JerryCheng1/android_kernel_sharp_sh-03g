...
struct shgrip_sens_setting_params {
    ...
    struct shgrip_prx_reg ps1_val[4];
    struct shgrip_prx_reg ps2_val[4];
    struct shgrip_prx_reg ps3_val[4];
    ...
    struct shgrip_prx_reg dtl_val[4];
    struct shgrip_prx_reg dtm_val[4];
    struct shgrip_prx_reg pnl_val[4];
