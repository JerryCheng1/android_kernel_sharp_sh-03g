/* drivers/sharp/shdisp/data/shdisp_bl71y8_data_dl.h  (Display Driver)
 *
...
/* ------------------------------------------------------------------------- */
#ifndef SHDISP_BL71Y8_DATA_DL_H
#define SHDISP_BL71Y8_DATA_DL_H
...
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX          (0x14)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX_LEVEL0   (0x14)
