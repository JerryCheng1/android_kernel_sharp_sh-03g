...
ATTR_SHOW_FN_COUNT(KEY_VOLUMEUP);
...
ATTR_STORE_FN_COUNT(KEY_VOLUMEUP);
ATTR_STORE_FN_COUNT(KEY_VOLUMEDOWN);

/*
 * /sys/devices/soc.0/gpio_keys.86/volumeup
 * /sys/devices/soc.0/gpio_keys.86/volumedown
 */
static DEVICE_ATTR(volumeup, S_IWUSR | S_IRUGO,
		   gpio_keys_show_count_KEY_VOLUMEUP,
		   gpio_keys_store_count_KEY_VOLUMEUP);
